		...
		<view :class="[direction==='column'?'uni-steps__column':'uni-steps__row']">
			...
			<view :class="[direction==='column'?'uni-steps__column-container':'uni-steps__row-container']" >
				<view :class="[direction==='column'?'uni-steps__column-line-item':'uni-steps__row-line-item']" 
					...
					<view :class="[direction==='column'?'uni-steps__column-check':'uni-steps__row-check']" 
						v-if="index === active">
						<view class="" style="width: 20rpx; height: 20rpx; background-color:#4a79e0; border-radius:50% ;">
							
						</view>
					</view>
					<view v-else :class="[direction==='column'?'uni-steps__column-circle':'uni-steps__row-circle']"  style="width: 20rpx; height: 20rpx; background-color:#4a79e0; border-radius:50% ;"
			...
			<view :class="[direction==='column'?'uni-steps__column-text-container':'uni-steps__row-text-container']" >
				<view v-for="(item,index) in options" :key="index"
					...
					<text :style="{color:index === active?activeColor:deactiveColor}" style="font-size: 20rpx;"
